...
export default function Project({
    ...
    >
    <section
        className=' bg-stone-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] mb-3 sm:mb-8 last:mb-0 hover:bg-stone-200 transition sm:group-even:pl-8 rounded-lg'>
